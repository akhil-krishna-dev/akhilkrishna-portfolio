...
export const chatApplication = {
	...
	// videoUrl:
	// 	"https://www.dropbox.com/scl/fi/9gss8thcsqtrc2jbjn2td/chat-applilcation-online-video-cutter.com.mp4?rlkey=btklz141qv3hnr2wazgpreop7&st=5qzzv2g8&raw=1",
	videoUrl:
	...
	links: {
		...
		gitHubBackendLink:
			"https://github.com/akhilkrishnair/chat-app-django-backend",
	},
	description:
		"The chat application was developed from scratch, demonstrating proficiency in both frontend and backend technologies. The backend is built using Django and Django Channels, leveraging WebSocket for real-time communication. The frontend is developed using React, providing a seamless and interactive user interface.",
	description2:
		"User authentication is handled using JWT, ensuring secure login and session management. Real-time messaging and notifications keep users engaged and informed of new messages. File sharing allows users to exchange images and documents effortlessly.",
	description3:
		"The application supports pagination and infinite scroll for chat history, ensuring that users can easily navigate through past conversations without overwhelming the browser. The responsive design ensures that the application works smoothly on various devices, from desktops to smartphones.",
	technologiesUsed:
		"Python, Django, REST API, Web Socket, Django Channels, React, MySQL, JWT, JavaScript, CSS, HTML.",
	homePageImages:
	...
	keyFeatures: [
		{
			...
			description:
				"Enables users to send and receive messages instantly without needing to refresh the page. This is achieved using WebSocket and Django Channels.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			title: "Voice Call",
			description:
				"Integrated WebRTC to enable voice call enhancing real-time communication.",
			screenShots: [
				{
					title: "making a call",
					image: voiceCall.voiceCallShot1,
				},
				{
					title: "receiving a call",
					image: voiceCall.voiceCallShot2,
				},
				{
					title: "attended a call",
					image: voiceCall.voiceCallShot3,
				},
			],
		},
		{
			title: "Video Call",
			description:
				"Integrated WebRTC to enable high-quality video call enhancing real-time communication.",
			screenShots: [
				{
					title: "making a call",
					image: videoCall.videoCallShot1,
				},
				{
					title: "receiving a call",
					image: videoCall.videoCallShot2,
				},
				{
					title: "attended a call",
					image: videoCall.videoCallShot3,
				},
			],
		},
		{
			...
			description:
				"Users can register, log in, and authenticate using JWT. Permissions ensure that users can only access their own data.",
			screenShots: [
				{
					title: "Login page",
		...
		},
		{
			title: "Files Sharing",
			description:
				" Users can share images, documents, and other files within the chat. The application supports various file formats and ensures secure storage and retrieval.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				"Enables users  to record, send and receive voice messages instantly.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				"Users receive notifications for new messages, even when they are not actively viewing the chat window.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				"Users online status updated when they are connected with websocket, even when they are not actively viewing the chat window.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				"Chat history is paginated and supports infinite scroll, allowing users to load more messages as they scroll up.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				"The chat application is fully responsive, providing an optimal user experience on both mobile and desktop devices.",
			screenShots: [
				{
...
export const eCommerce = {
	...
	links: {
		...
		gitHubBackendLink:
			"https://github.com/akhilkrishnair/e-commerce-django-backend",
	},
	description:
	...
	technologiesUsed:
		" Python, Django, REST API, React, PostgreSQL, JWT, JavaScript, HTML, CSS, Bootstrap, Nginx, AWS EC2, S3.",
	keyFeatures: [
		{
			title: "Home page",
			description:
				" Home page with product category collection, best offers, recent products viewed by user and product search area.",
			screenShots: [
				{
		...
		},
		{
			...
			description:
				" Implemented secure user authentication and authorization functionality to ensure user data privacy and access control.",
			screenShots: [
				{
					title: "Registration page",
		...
		},
		{
			...
			description:
				"Created a comprehensive product management system allowing administrators to add, edit, and delete products, as well as manage product variants.",
			screenShots: [],
		},
		{
			title: "Shopping Cart",
			description:
				"Implemented a dynamic shopping cart feature enabling users to add products, update quantities, and remove items from their cart.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			...
			description:
				"Integrated product search functionality to enable users to easily find products based on keywords or categories.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			...
			description:
				"Developed a product details page with information about the product, available variants, and the option to select desired variants before adding to the cart.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			...
			description:
				" Implemented Razorpay to securely process payments. Integrated features such as order creation, payment capturing, and handling webhooks for real-time payment status updates.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			...
			description:
				"Implemented a streamlined order processing system allowing users to place orders securely, view order history, and track the status of their orders.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			...
			description:
				"Added a wishlist feature enabling users to save products for future purchase consideration.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			title: "Review System",
			description:
				"Implemented a review system allowing registered users to leave reviews and ratings for products they have purchased, enhancing product transparency and aiding other users in their purchase decisions.",
			screenShots: [
				{
					title: "shot 1",
		...
		},
		{
			title: "Responsive Design",
			description:
				"The E-shop is fully responsive, providing an optimal user experience on both mobile and desktop devices.",
			screenShots: [
				{
